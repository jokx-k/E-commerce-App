...
public class OrdersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sp = getApplicationContext().getSharedPreferences("Remember Me", Context.MODE_PRIVATE);
        username = sp.getString("Username", "");
        c = dobj.Get_Cust_Data(username);
        email = c.getString(4);
...
//                    ((TextView)dialogview.findViewById(R.id.popup_done_txt_email_confirmation)).setText("A confirmation email is sent to  " + email );


                    dialogview.findViewById(R.id.popup_confirm).setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {

                            final View dialogview = inflater.inflate(R.layout.popup_confirmed, null);
                            final AlertDialog dialog1 = new AlertDialog.Builder(OrdersActivity.this).create();
                            dialog1.setView(dialogview);
//                            ((TextView)dialogview.findViewById(R.id.popup_done_txt_total_payment)).setText("Total Payment is " + total_price_that_customer_will_pay + " EGP");
                            ((TextView) dialogview.findViewById(R.id.popup_done_txt_email_confirmation)).setText("A confirmation email is sent to  " + email);

                            Email mail = new Email(getApplicationContext(), email, "Abdo Store","Hello");
                            mail.execute();

                            dialogview.findViewById(R.id.popup_ok).setOnClickListener(new View.OnClickListener() {
                                @Override
                    ...
                    dialogview.findViewById(R.id.popup_cancel).setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                ...
                public void onClick(View v) {
                    ...
                    if (entered_quantity > cur_quantity) {
                        ...
                        if (available_in_stock_or_not == true) {
                            ...
                            dobj.NewQuantity(p.ProductID, actual_quanttiy_from_databse - (entered_quantity - cur_quantity));
